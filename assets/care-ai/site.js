...
(() => {
  ...
  const examples = [
    {title:'メモの整理は、相棒に。',intro:'思いつくままに書いたメモも、相手が読みやすい順番に整理する下書きに。',before:'来週火曜に研修。資料は金曜まで。新人さんも参加。場所は会議室。担当は自分。',after:'【研修のご案内・下書き】\n日時：来週火曜日（時間は要確認）\n場所：会議室\n対象：新人を含む職員\n準備：金曜までに資料を用意\n担当：案内者（氏名を確認）',next:'最初は、日付や固有名詞を伏せた会議メモひとつから。書いていないことを補わない指示も、一緒に整えます。'},
    {title:'伝え方を考える、もう一人。',intro:'研修のテーマを渡して、構成や練習問題のたたき台を相談できます。',before:'新人向けに、メモの残し方を説明したい。10分くらい。話を聞くだけでなく、自分で試してほしい。',after:'【10分研修の構成案】\n2分：誰に・何を伝えるメモか考える\n3分：日時・事実・次の行動に分ける\n3分：架空の会議メモを整理する\n2分：二人で読み比べ、抜けを確認',next:'まずは、いつもの説明をひとつ。現場のルールに合っているか確かめながら、職員さんが試せる資料を作りましょう。'},
    {title:'「伝えたい」を、一緒に形に。',intro:'思いはあるのに文章にできない。そんなときは、読み手と目的から一緒に整理します。',before:'職場見学に来てほしい。施設の雰囲気がわかる会にしたい。写真も載せたい。詳細はまだ決まっていない。',after:'【お知らせの構成案】\n見出し：まずは、職場の空気を見に来ませんか。\n紹介：普段の様子がわかる写真とひと言\n詳細：日時・場所・参加対象を確認して記載\n案内：申込方法と問い合わせ先を決める',next:'このホームページも、AIと一緒に作りました。誰に何を伝えたいかを出発点に、文章から見た目までご相談いただけます。'},
    {title:'考え途中でも、話せる相棒。',intro:'正解を出してもらうだけでなく、考えを広げる質問を返してもらう使い方も。',before:'職員同士で話す時間を増やしたい。でも、みんな忙しい。長い会議を増やしたいわけではない。',after:'【相棒からの問いの例】\n・まず誰と誰が話せると、うれしい？\n・今ある時間に、3分だけ足せそう？\n・困りごとと「よかったこと」、どちらから？\n・一週間だけ試すなら、何をする？',next:'答えが決まっていなくても大丈夫。人やチームの強みも聴きながら、まず試してみる一歩を一緒に見つけます。'}
  ];
